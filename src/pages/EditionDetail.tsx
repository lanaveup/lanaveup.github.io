...
const EditionDetail = () => {
  ...
  const editionArticles = articles.filter(article => 
    edition.articles.includes(article.id)
  );
        ...
        <section className={`relative py-24 overflow-hidden bg-gradient-to-br ${edition.featuredColor}`}>
          ...
          <div className="container relative z-10">
            ...
            >
              <Link 
                to="/ediciones" 
                className="inline-flex items-center text-white/80 hover:text-white mb-6 group transition-colors"
              >
          ...
          <div className="container">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="md:w-1/3">
                {prevEdition ? (
                  <Link to={`/ediciones/${prevEdition.id}`} className="group block">
              ...
              <div className="md:w-1/3 text-right">
                {nextEdition ? (
                  <Link to={`/ediciones/${nextEdition.id}`} className="group block">
