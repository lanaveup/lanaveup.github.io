        ...
        <section className="py-20 bg-gradient-to-b from-background via-background to-white/70">
          <div className="container px-0 mx-[130px]">
            ...
            duration: 0.5
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Descubre todas nuestras ediciones anteriores con análisis detallados del ecosistema startup.</h1>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">Descubre todas nuestras ediciones anteriores con análisis detallados del ecosistema startup. </p>
            </motion.div>
            ...
            margin: "-100px"
              ...
              {editions.map(edition => <motion.div key={edition.id} variants={item}>
